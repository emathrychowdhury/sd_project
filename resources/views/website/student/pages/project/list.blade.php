                ...
                @if ($projects)
                    @foreach ($projects as $p)
                        <tr>
                            ...
                            <td>{{ $p->description }}</td>
                            <td>
                                <a href="{{ URL::to('edit-project/'. $p->id) }}" class="btn btn-warning text-decoration-none btn-sm">Edit</a>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="{{ URL::to('delete-project/' . $p->id) }}" class="btn btn-danger">Delete</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
