                ...
                <div class="signup-form">
                    ...
                    <form action="{{ URL::to('/register-store') }}" method="post">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col"><input type="text" class="form-control" name="username" placeholder="Student Name"
                                        required="required">
                                </div>
                        ...
                        <div class="form-group">
                            <input type="email" class="form-control" name="useremail" placeholder="Student Email Address" required="required">
                        </div>
                        <div class="form-group">
                            <input type="number" class="form-control" name="studentid" placeholder="Student ID" required="required">
                        </div>
                        <div class="form-group">
